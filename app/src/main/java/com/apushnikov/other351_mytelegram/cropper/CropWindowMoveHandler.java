...
/**=============================================================================================
 * CropWindowMoveHandler - Обработчик для обновления краев окна обрезки по типу перемещения
 * — по горизонтали, вертикали, углу или по центру.
 * <br>
 */
final class CropWindowMoveHandler {
   ...
   * horizontalEdge the primary edge associated with this handle; may be null
   * verticalEdge the secondary edge associated with this handle; may be null
   ...
   *     edges.
   * parentView the parent View containing the image
