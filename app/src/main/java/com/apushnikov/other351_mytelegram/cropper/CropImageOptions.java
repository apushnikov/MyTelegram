...
/**=========================================================================================
 * CropImageOptions - Все возможные параметры, которые можно настроить для настройки
 * кадрирования изображения.<br>
 * Инициализирован значениями по умолчанию.
 */
public class CropImageOptions implements Parcelable {
   ...
   *
   * @throws IllegalArgumentException если какой-либо из вариантов недействителен
   */
